...
<html>
    ...
    <body id="homepage">
        <h1 id="homeTitle">Bloons Tower Defense - ICS3U Summative Programming Project</h1>
        ...
        <script>
            ...
            function bubbleSortBloonPopped()
                {
                    ...
                    //To help us bubble sort I used https://www.youtube.com/watch?v=RqfWvIsYmsc&ab_channel=AndyWicksw
                       ...
                       /*****************************************************************************************
            THIS FUNCTION CHECKS WITH BLOON IS THE MOST POPPED
            *****************************************************************************************************/
            function firstPlacePopped()
            {
                let first="";//This variable does not need to be accessed anywhere else other than this function so it it local
                let mostPopped=bubbleSortBloon[bubbleSortBloon.length-1];
                if(mostPopped==redPop)
                    {
                        first="Red Bloon";
                    }
                if(mostPopped==bluePop)
                    {
                        first="Blue Bloon";
                    }
                if(mostPopped==greenPop)
                    {
                        first="Green Bloon";
                    }
                if(mostPopped==camoRedPop)
                    {
                        first="Camo Red Bloon";
                    }
                if(mostPopped==camoBluePop)
                    {
                        first="Camo Blue Bloon";
                    }
                if(mostPopped==camoGreenPop)
                    {
                        first="Camo Green Bloon";
                    }
                if(alertOnce==true)
                    {
                        alert("The highest type of bloon you popped was the " + first + " and you popped it " + mostPopped + " time(s)!");
                    }
                alertOnce=false;
            }
            //bloon.x coordinate function
            function bloonX(num);
                for(var i = 0; i < num; i++){
                    bloon.x=-100000000;
                }
            /*******************************************************************************************
                THIS FUNCTION CHECKS WITH BLOON IS THE SECOND MOST POPPED
                **************************************************************************************************/
            function secondPlacePopped()
                {
                    let second="";//This variable does not need to be accessed anywhere else other than this function so it it local
                    let secondMostPopped=bubbleSortBloon[bubbleSortBloon.length-2];
                     if(secondMostPopped==redPop)
                        {
                            second="Red Bloon";
                        }
                    if(secondMostPopped==bluePop)
                        {
                           second="Blue Bloon";
                        }
                    if(secondMostPopped==greenPop)
                        {
                            second="Green Bloon";
                        }
                    if(secondMostPopped==camoRedPop)
                        {
                            second="Camo Red Bloon";
                        }
                    if(secondMostPopped==camoBluePop)
                        {
                            second="Camo Blue Bloon";
                        }
                    if(secondMostPopped==camoGreenPop)
                        {
                            second="Camo Green Bloon";
                        }
                    if(alertOnce2==true)
                        {
                            alert("The second highest type of bloon you popped was the " + second + " and you popped it " + secondMostPopped + " time(s)!");
                        }
                    alertOnce2=false;
                }
            /*******************************************************************************************
                THIS FUNCTION CHECKS WITH BLOON IS THE THIRD MOST POPPED
                ****************************************************************************************/
            function thirdPlacePopped()
                {
                    let third="";//This variable does not need to be accessed anywhere else other than this function so it it local
                    let thirdMostPopped=bubbleSortBloon[bubbleSortBloon.length-3];
                     if(thirdMostPopped==redPop)
                        {
                            third="Red Bloon";
                        }
                    if(thirdMostPopped==bluePop)
                        {
                           third="Blue Bloon";
                        }
                    if(thirdMostPopped==greenPop)
                        {
                            third="Green Bloon";
                        }
                    if(thirdMostPopped==camoRedPop)
                        {
                            third="Camo Red Bloon";
                        }
                    if(thirdMostPopped==camoBluePop)
                        {
                            third="Camo Blue Bloon";
                        }
                    if(thirdMostPopped==camoGreenPop)
                        {
                            third="Camo Green Bloon";
                        }
                    if(alertOnce3==true)
                    {
                        alert("The third highest type of bloon you popped was the " + third + " and you popped it " + thirdMostPopped + " time(s)!");
                        endscreen();
                    }
                    alertOnce3=false;
                }
            ...
            *********************************************************************/
            ...
            function names()//string function 
                {
                    //all scoped within the function
                    let name = prompt("Enter Your Username (May Include Special Characters): ");//prompts for name from user
            ...
            class mainGame extends Phaser.Scene {
                ...
                preload ()
                {
                    ...
                    this.load.image('shopBoom', 'extras/boomerangman.png');
                    ...
                    this.load.image('boom','towerSprites/Boomerang_Thrower.png');
                    ...
                    this.load.audio('popSound', 'music/pop.mp3');
                ...
                { 
                    ...
                    let camoRedRange=20;
                    let blueRange=25;
                    let camoBlueRange=30;
                    let greenRange=25;
                    let camoGreenRange=30;
                    //audio
                    var music;
                    ...
                    for(let x=0;x<10;x++)
                        {
                            boom = this.add.sprite(922, 412, 'boom');
                            
                            boom.setInteractive();

                            this.input.setDraggable(boom);

                            booms.unshift(boom);
                        }
                    let shopBoom = this.add.sprite(922, 412, 'shopBoom');
                    let crossHairGold = this.add.sprite(922, 416, 'crossHairGold');
                   ...
                   for (let i=0;i<=redRange;i++)
                    {
                        ...
                        this.time.addEvent({ delay: i*7000, callback:_this.startBloon , callbackScope: this, loop: false});
                    }   
                    ...
                    for (let i=0;i<=blueRange;i++)
                    {
                        ...
                        this.time.addEvent({ delay: i*5000, callback:_this.startBlueBloon , callbackScope: this, loop: false});
                    }
                    for (let i=0;i<=camoBlueRange;i++)
                    {
                        arrCamoBlue[i]=this.add.follower(actualPath,10,525,'camoblue');
                        this.time.addEvent({ delay: i*4500, callback:_this.startCamoBlueBloon , callbackScope: this, loop: false});
                    }
                    for (let i=0;i<=greenRange;i++)
                    {
                        arrGreenBloons[i]=this.add.follower(actualPath,10,525,'greenbloon');
                        this.time.addEvent({ delay: i*3500, callback:_this.startGreenBloon , callbackScope: this, loop: false});
                    }
                    for (let i=0;i<=camoGreenRange;i++)
                    {
                        arrCamoGreen[i]=this.add.follower(actualPath,10,525,'camogreen');
                        this.time.addEvent({ delay: i*3000, callback:_this.startCamoGreenBloon , callbackScope: this, loop: false});
                    }
