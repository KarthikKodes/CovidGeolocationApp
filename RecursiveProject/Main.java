...
//***OBJECTIVE OF PROGRAM: Using recursive functions and classes, find an object (earth) from start point (robot) moving only a random number of units vertically or horizontally. Keep applying this recursive function until the object (earth is found) and replaced with hitmarker (fire emoji).***\\
// 0 = empty
// 1 = miss
// 2 = element
// 3 = hit
